...
class SettingEditPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return HolocareLayout(
      leading: true,
      onPressedAppbar: () => router.pop(),
      title: Text(
        userViewModel.user?.role == Role.protege.role ? "보호자 등록" : "보호자 연결",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(20),
                      for (int order = 1; order <= protectors.length; order++)
                        SettingEditItem(
                          title: "보호자 $order",
                          order: order,
                          onTap: () {
